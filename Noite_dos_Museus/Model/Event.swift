...
let event1 = Event(id: 1, eventImage: "Érico Moura", name: "Érico Moura", hour: "21h", local: "MARGS", description: "O Músico, cantor e compositor Érico Moura, nascido em Porto Alegre traz um grande espetáculo de violão para a Noite dos Museus.")
